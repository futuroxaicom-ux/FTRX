...
const BOT_CONFIG_FIELDS = {
  ...
  sniper: [
    ...
    { key: 'partial_sell_percent', label: 'Partial sell przy +X%', type: 'number', step: 1 },
    { key: 'partial_sell_amount', label: 'Ile sprzedać (%) na partial', type: 'number', step: 5 },
    { key: 'take_profit_percent', label: 'Take Profit - pełna sprzedaż (%)', type: 'number', step: 1 },
    { key: 'quick_stop_loss_percent', label: 'Quick Stop Loss (%)', type: 'number', step: 1 },
    { key: 'quick_stop_loss_minutes', label: 'Quick SL - w ciągu (min)', type: 'number', step: 1 },
    { key: 'stop_loss_percent', label: 'Stop Loss ogólny (%)', type: 'number', step: 1 },
    ...
    { key: 'max_pool_age_seconds', label: 'Max wiek puli (s) - 300=5min', type: 'number' },
